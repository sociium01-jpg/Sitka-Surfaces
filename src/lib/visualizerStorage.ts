...
import { VisualizerScene, VisualizerZone, Finish, HubPageSectionConfig, FAQ, ComparisonMatrix, Project } from '@/types/visualizer';
...
export function readVisualizerDb(): VisualizerJSONDb {
  try {
    ...
    if (!data.spaceTypes) data.spaceTypes = [];
